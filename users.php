						...
						<div class="col-lg-4 single-services">
							<div class="card text-center" style="width: 18rem;">
								...
								<div class="card-body">
									...
									<a href="" class="btn btn-primary" data-toggle="modal" data-target="#myModal" > Click  </a>
								</div>
							</div>
						</div>
						...
						<div class="col-lg-4 single-services">
							<div class="card text-center" style="width: 18rem;">
								...
								<div class="card-body">
									...
									<a href="" class="btn btn-primary" data-toggle="modal" data-target="#myModal2"> Click  </a>
								</div>
							</div>
						</div>
					</div>
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											<form action="signup_script.php" method="POST">
												...
												<div class="form-group">
													<label> Id (Admin(1-99),Expert(100-999),Officer(>=1000)) </label>
