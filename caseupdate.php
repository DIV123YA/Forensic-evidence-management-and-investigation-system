<?php
    ...
    $cases = "SELECT * FROM CASES WHERE CASE_ID = '" . $updcaseid . "'";
    $run_cases = mysqli_query($con, $cases);
    $cases_r = mysqli_fetch_array($run_cases);

    $evi = "SELECT * FROM EVIDENCE WHERE CASE_ID = '" . $updcaseid . "'";
    $run_evi = mysqli_query($con, $evi);
    $evi_r = mysqli_fetch_array($run_evi);

    $susp = "SELECT * FROM SUSPECTS WHERE CASE_ID = '" . $updcaseid . "'";
    $run_susp = mysqli_query($con, $susp);
    $susp_r = mysqli_fetch_array($run_susp);

    $known = "SELECT * FROM KNOWN_FORENSICS WHERE CASE_ID = '" . $updcaseid . "'";
