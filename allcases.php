						...
						<div class="col-lg-3 single-services">
							<div class="card text-center" style="width: 18rem;">
								...
								<div class="card-body">
									...
									<a href="caseopen.php" class="btn btn-primary"> View  </a>
								</div>
							</div>
						</div>
						...
						<div class="col-lg-3 single-services">
							<div class="card text-center" style="width: 18rem;">
								...
								<div class="card-body">
									...
									<a href="caseclosed.php" class="btn btn-primary"> View  </a>
								</div>
							</div>
						</div>
						...
						<div class="col-lg-3 single-services">
							<div class="card text-center" style="width: 18rem;">
								...
								<div class="card-body">
									...
									<a href="casepending.php" class="btn btn-primary"> View </a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-lg-4 offset-lg-2 single-services">
							<div class="card text-center" style="width: 18rem;">
								...
								<div class="card-body">
									<h5 class="card-title"> Lab_and_lab_tech_Details </h5>
									<p class="card-text"> View Lab_and_lab_tech_ Details </p>
									<a href="lab_and_lab_tech_view.php" class="btn btn-primary"> View  </a>
								</div>
							</div>
						</div>
