						...
						<div class="col-lg-4 single-services">
							<div class="card text-center" style="width: 18rem;">
								...
								<div class="card-body">
									...
									<a href="insertcase.php" class="btn btn-primary"> Click  </a>
								</div>
							</div>
						</div>
						...
						<div class="col-lg-4 single-services">
							<div class="card text-center" style="width: 18rem;">
								...
								<div class="card-body">
									...
									<a href="#myModal2" class="btn btn-primary" data-toggle="modal" data-target="#myModal2"> Click  </a>
								</div>
							</div>
						</div>
						...
						<div class="col-lg-4 single-services">
							<div class="card text-center" style="width: 18rem;">
								...
								<div class="card-body">
									...
									<p class="card-text"> View Case Status </p>
									<a href="view.php" class="btn btn-primary"> Click  </a>
								</div>
							</div>
						</div>
					</div>
